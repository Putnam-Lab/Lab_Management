---
layout: post
title: Protocol for measuring photosynthetic efficiency using Underwater Diving-PAM
date: 2026-02-11
...
8. Now proceed with repeating the steps 4-7 for all the other coral fragments you are wishing to obtain the PAM data off.
